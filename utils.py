...
def target_DOA_estimation(data,xrPixels, range_idx,doppler_idx,fov=[-90,90],antenna_spacing_wl=0.5, DOA_method="Bartlett"):
    """
...
def create_target_list(rd_all_channels_az=None,
    ...
    rd_cfar, fps_cfar = peak_detector2(rd_all_channels_az[0],max_detections=max_detections,threshold_rel=rel_peak_threshold)
